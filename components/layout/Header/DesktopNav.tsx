  ...
  const NavItemWithDropdown = ({ item }: { item: CategoryItem }) => {
      ...
      return (
        ...
        >
          <button
            ...
            className={`flex items-center font-semibold transition-all duration-200 py-2 px-3 lg:px-4 rounded-lg border ${
              isActive 
            ...
            } text-sm lg:text-base relative z-10 transform-gpu`}
          >
            ...
            <span className={`absolute bottom-0 left-1/2 transform -translate-x-1/2 w-8 h-0.5 bg-blue-400 transition-all duration-200 ${
          ...
          {(isActive) && item.subItems && (
            <div 
              ...
              className="absolute top-full left-0 mt-1 w-64 bg-slate-800 border border-slate-600 rounded-lg shadow-2xl z-[9999] overflow-hidden"
              style={{
                maxHeight: dropdownHeight > 300 ? '300px' : 'auto',
            ...
            >
              ...
              {dropdownHeight > 300 && (
                <div className="absolute bottom-0 left-0 right-0 h-6 bg-gradient-to-t from-slate-800 to-transparent pointer-events-none flex items-center justify-center">
                  <div className="w-6 h-1 bg-blue-400/30 rounded-full"></div>
                </div>
              )}
            </div>
          )}
    ...
    return (
      <Link
        ...
        className="group relative flex items-center text-white hover:text-blue-300 font-semibold transition-all duration-200 py-2 px-3 lg:px-4 rounded-lg hover:bg-slate-800 border border-transparent hover:border-slate-600 text-sm lg:text-base transform-gpu hover:scale-105"
        key={item.id}
        onMouseEnter={() => handleMouseEnter(item.id)}
        onMouseLeave={handleMouseLeave}
      >
        ...
        {/* Hover indicator line */}
        <span className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-8 h-0.5 bg-blue-400 transition-all duration-200 opacity-0 scale-x-0 group-hover:opacity-100 group-hover:scale-x-100" />
      </Link>
    );
  };
    ...
    return (
      ...
      >
        ...
        >
          ...
          {/* Hover indicator line */}
          <span className={`absolute bottom-0 left-1/2 transform -translate-x-1/2 w-8 h-0.5 bg-green-400 transition-all duration-200 ${
            isActive ? 'opacity-100 scale-x-100' : 'opacity-0 scale-x-0 group-hover:opacity-100 group-hover:scale-x-100'
          }`} />
        </button>
        ...
        {(isActive) && item.subItems && (
          ...
          >
            ...
            {dropdownHeight > 300 && (
              <div className="absolute bottom-0 left-0 right-0 h-6 bg-gradient-to-t from-slate-800 to-transparent pointer-events-none flex items-center justify-center">
                <div className="w-6 h-1 bg-green-400/30 rounded-full"></div>
              </div>
            )}
          </div>
        )}
